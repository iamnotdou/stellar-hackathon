...
export default function EarnRewardsPage() {
  ...
  const prizeDescriptions = [
    { name: '100$', description: 'Instant cash reward - 100 dollar value added to your wallet' },
    ...
    { name: 'EMPTY', description: 'Try again - Better luck next time, keep spinning for amazing prizes!' },
    { name: '500$', description: 'Big cash prize - 500 dollar value deposited directly to your account' },
    ...
    { name: 'JACKPOT', description: 'Ultimate prize - 1000$ cash + Premium NFT + 5 Free tickets combo!' }
  ];
                        ...
                        <div className="flex items-start gap-3">
                          <div className="flex-shrink-0">
                            <div className={`px-2 py-1 rounded text-xs font-bold border corner-accents ${
                              ...
                              prize.name === '500$' || prize.name === 'NFT' ? 'bg-yellow-500/20 text-yellow-500 border-yellow-500/30' :
          ...
          <div className="border corner-accents bg-background p-8 max-w-md w-full mx-auto space-y-6 relative">
            ...
            <div className="text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">You won an amazing prize!</p>
              </div>
              ...
              <div className="border corner-accents bg-accent/5 p-6 space-y-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Your reward has been added to your account</p>
                </div>
              </div>
