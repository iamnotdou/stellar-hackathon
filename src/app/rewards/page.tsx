  ...
  const prizeDescriptions = [
    {
      name: "0.01ETH",
      description:
        "Instant crypto reward - 0.01 ETH value added to your wallet",
    },
    {
      name: "BONUS",
      description:
        "Special bonus multiplier - Next ticket purchase gets 2x rewards",
    },
    {
      name: "TICKET",
      description:
        "Free event ticket - Choose any available event worth up to 0.5 ETH",
    },
    {
      name: "EMPTY",
      description:
        "Don't worry, try again - Better luck next time, keep spinning for amazing prizes!",
    },
    {
      name: "0.05ETH",
      description:
        "Big crypto prize - 0.05 ETH value deposited directly to your account",
    },
    {
      name: "SPIN",
      description:
        "Extra spin bonus - Get an additional free fortune wheel spin immediately",
    },
    {
      name: "NFT",
      description:
        "Exclusive NFT reward - Limited edition Sticket collectible for your wallet",
    },
    {
      name: "JACKPOT",
      description:
        "Ultimate prize - 0.1 ETH + Premium NFT + 5 Free tickets combo!",
    },
  ];
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {prizeDescriptions.map((prize, index) => (
                      <div
                        key={index}
                        className="border corner-accents p-3 hover:bg-muted/30 transition-colors"
                      >
                        <div className="flex items-start gap-3">
                          <div className="flex-shrink-0">
                            <div
                              className={`px-2 py-1 rounded text-xs font-bold border corner-accents ${
                                prize.name === "JACKPOT"
