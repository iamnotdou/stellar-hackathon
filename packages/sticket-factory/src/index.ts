...
export const networks = {
  testnet: {
    ...
    contractId: "CAIQBEI4GEZSNMYCPEWTGR7IYXBS4Q6GY7CDJJOTDMHDPCOIQZ2FNMRC",
  },
} as const;

export type DataKey =
  | { tag: "WasmHash"; values: void }
  | { tag: "EventCounter"; values: void }
  | { tag: "EventRecord"; values: readonly [u32] }
  | { tag: "CreatorEvents"; values: readonly [string] }
  | { tag: "AllEvents"; values: void };
...
export interface Client {
   ...
   */
  get_event: (
    { event_id }: { event_id: u32 },
    options?: AssembledTransactionOptions<EventRecord>
  ) => Promise<AssembledTransaction<EventRecord>>;
   ...
   */
  get_all_events: (
    options?: AssembledTransactionOptions<Array<EventRecord>>
  ) => Promise<AssembledTransaction<Array<EventRecord>>>;
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([
        ...
        "AAAAAgAAAAAAAAAAAAAAB0RhdGFLZXkAAAAABQAAAAAAAAAAAAAACFdhc21IYXNoAAAAAAAAAAAAAAAMRXZlbnRDb3VudGVyAAAAAQAAAAAAAAALRXZlbnRSZWNvcmQAAAAAAQAAAAQAAAABAAAAAAAAAA1DcmVhdG9yRXZlbnRzAAAAAAAAAQAAABMAAAAAAAAAAAAAAAlBbGxFdmVudHMAAAA=",
