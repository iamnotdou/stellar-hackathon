...
export const networks = {
  testnet: {
    ...
    contractId: "CBQKR73PO65FQEWSP6NBTFILLKZZ5NBZS2NPNVRD7UOAWAFHVP3LSOV2",
  },
} as const;

export type DataKey =
  | { tag: "EventInfo"; values: void }
  | { tag: "Ticket"; values: readonly [u32] }
  | { tag: "TicketsMinted"; values: void }
  | { tag: "SecondaryListing"; values: readonly [u32] }
  | { tag: "UserTickets"; values: readonly [string] };
...
export interface Client {
   ...
   */
  get_ticket: (
    { ticket_id }: { ticket_id: u32 },
    options?: AssembledTransactionOptions<TicketData>
  ) => Promise<AssembledTransaction<TicketData>>;
  ...
  list_ticket: (
    {
      ...
      ticket_id,
      price,
    }: { seller: string; ticket_id: u32; price: i128 },
    options?: AssembledTransactionOptions<null>
  ) => Promise<AssembledTransaction<null>>;
   ...
   */
  delist_ticket: (
    { seller, ticket_id }: { seller: string; ticket_id: u32 },
    options?: AssembledTransactionOptions<null>
  ) => Promise<AssembledTransaction<null>>;
   ...
   */
  get_event_info: (
    options?: AssembledTransactionOptions<EventInfo>
   ...
   */
  transfer_ticket: (
    { from, to, ticket_id }: { from: string; to: string; ticket_id: u32 },
    options?: AssembledTransactionOptions<null>
  ) => Promise<AssembledTransaction<null>>;
  ...
  get_user_tickets: (
    { user }: { user: string },
    options?: AssembledTransactionOptions<Array<u32>>
   ...
   */
  mark_ticket_used: (
    { creator, ticket_id }: { creator: string; ticket_id: u32 },
    options?: AssembledTransactionOptions<null>
  ) => Promise<AssembledTransaction<null>>;
   ...
   */
  buy_secondary_ticket: (
    { buyer, ticket_id }: { buyer: string; ticket_id: u32 },
    options?: AssembledTransactionOptions<null>
  ) => Promise<AssembledTransaction<null>>;
  ...
  update_listing_price: (
    {
      ...
      ticket_id,
      new_price,
    }: { seller: string; ticket_id: u32; new_price: i128 },
    options?: AssembledTransactionOptions<null>
  ) => Promise<AssembledTransaction<null>>;
   ...
   */
  get_secondary_listing: (
    { ticket_id }: { ticket_id: u32 },
    options?: AssembledTransactionOptions<Option<SecondaryListing>>
  ) => Promise<AssembledTransaction<Option<SecondaryListing>>>;
   ...
   */
  get_all_secondary_listings: (
    options?: AssembledTransactionOptions<Array<SecondaryListing>>
  ) => Promise<AssembledTransaction<Array<SecondaryListing>>>;
}
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([
        ...
        "AAAAAgAAAAAAAAAAAAAAB0RhdGFLZXkAAAAABQAAAAAAAAAAAAAACUV2ZW50SW5mbwAAAAAAAAEAAAAAAAAABlRpY2tldAAAAAAAAQAAAAQAAAAAAAAAAAAAAA1UaWNrZXRzTWludGVkAAAAAAAAAQAAAAAAAAAQU2Vjb25kYXJ5TGlzdGluZwAAAAEAAAAEAAAAAQAAAAAAAAALVXNlclRpY2tldHMAAAAAAQAAABM=",
